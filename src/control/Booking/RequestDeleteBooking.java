	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (patient == null) {
			...
			if(carriedOut == null || carriedOut.equalsIgnoreCase("True")) {
				...
				doctor.setSurname(request.getParameter("doctor_user_name"));
				...
				if(booking_date == null) {
					...
					RequestDispatcher dispatcher = request.getRequestDispatcher("Patient/Booking/BookingCancelConfirmation.jsp");
